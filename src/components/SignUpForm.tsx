    ...
    <div className="flex justify-center min-h-screen p-4 ">
      <Form {...form}>
        ...
        >
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6 py-8 space-y-6 md:space-y-0">
            <Label className="text-xl md:col-span-3">{emergencyContact}</Label>
            <FormField
              control={form.control}
              name="contactName"
              render={({ field }) => (
          ...
          <div className="md:grid md:grid-cols-1 md:gap-6 py-8 space-y-6 md:space-y-0">
            ...
            <ScrollArea className="h-[200px] w-[380px] rounded-md border p-4 md:col-span-1">
              ...
              <p>
                Asociar a los propietarios de vehículos eléctricos personal para
                fomentar la cultura de un buen uso de estos aparatos eléctricos
                como actores viales, integrando las personas sin distinguir
                clase social, estrato económico, religioso o étnico, disfrutando
                la geografía Colombiana en procura de lograr el crecimiento
              ...
              <p>
                2. Podrá ingresar cualquier persona por invitación de uno de los
              ...
              <p>
                8. Una vez se le informe la validación de la factura, se le dará
                ingreso al aspirante y tendrá 5 minutos para que en un breve
                párrafo se presente al grupo de WhatsApp, indicando: ocupación,
                profesión, edad, barrio, tipo de vehículo eléctrico personal,
                tiempo como usuario de movilidad eléctrica, edad, acompañado de
                la foto suya junto al vehículo eléctrico personal.
              </p>
              <br />
              <b>
              ...
              <p>
                ...
                Club, así mismo en las conversaciones que se tengan en el grupo
                de WhatsApp.
              </p>
              <p>
                3. Los miembros deben confirmar su asistencia e informar
                anticipadamente de su inasistencia a las personas designadas por
                el Club cuando de actividades, reuniones, paseos y eventos
              ...
              <p>
                1) Todo miembro tiene derecho a postularse a parte de la mesa de
                trabajo cuando exista la convocatoria.
              </p>
              <p>
              ...
              <p> f) No tener negocios relacionados con movilidad eléctrica.</p>
              ...
              <p>
                ...
                organizadores de los eventos (salidas, celebraciones, reuniones,
                etc.) con el ánimo de desestabilizar la unidad del Club.
              </p>
              <p>
              ...
              <p>
                10. Cualquier acto de irrespeto, acoso, intimidación hacia algún
                integrante del club.
              </p>
              <br />
              <b>
              ...
              <p>
                ...
                las señales de mano o pito, el plan de salida, el orden de cada
                vehículo eléctrico personal en la caravana, las paradas
                acordadas y todo lo concerniente al lugar de llegada.
              </p>
              <p>
                2. En el punto de salida el presidente o su delegado revisará el
                estado del vehículo eléctrico personal y kit de protección del
                miembro del club, esta prohibido salir a rodar sin uso de casco
                como mínimo.
              </p>
              <p>
              ...
              <p>
                4. Todo miembro debe portar vestimenta adecuada en todo momento;
                casco homologado, calzado, chaqueta, guantes, impermeable y los
                distintivos del Club. En caso de lluvia vinipel y portar el
                chaleco reflectante sobre el impermeable para ser más visibles.
              </p>
              <p>
                5. Los integrantes del Club deben de ser cordiales con los demás
                vehículos en circulación, por respeto y cultura, respetaremos
                las normas de tránsito en todo momento.
              </p>
              <p>
                6. No se permitirán integrantes en estado de embriaguez en todas
                sus etapas o bajo los efectos de sustancias alucinógenas, antes
                o durante la rodada.
              </p>
              <p>
              ...
              <p>
                8. Se programará como cabeza de caravana a la persona con mayor
                experiencia en rodadas, detrás de este deberá ir la persona que
                más conozca el destino al que el Club desea llegar, en segundo
                lugar, los vehículos eléctricos con menor autonomía, en los
                últimos lugares los vehículos eléctricos de mayor potencia y en
                la cola de la caravana irá el piloto con mejores conocimientos
                de mecánica.
              </p>
              <p>
                9. Nadie debe de adelantar a sus compañeros, ni tampoco
                continuar la marcha cuando uno de ellos presente problemas en el
                trayecto. En este caso deberán pitar 3 veces y estacionar a un
                lado de la vía con todas las medidas de precaución posibles. Se
                podría realizar un adelantamiento por una necesidad apremiante o
                una eventualidad mayor.
              </p>
              <p>
              ...
              <p>
                11. Cuando se circule en grupo, se hará todo lo posible para no
                romperlo, es decir los más rápidos y experimentados esperarán y
                ayudarán a los más lentos, porque el fin del club es la unión de
                todos sus miembros y el disfrutar con las rutas, y no competir
                ni llegar lo más rápido al destino, sino disfrutar al máximo
                hasta llegar a él.
              </p>
              <p>
                ...
                salidas programadas, pero deberán apoyarse entre sí para dar una
                solución rápida y sobrellevar el percance apropiadamente.
              </p>
              <p>
              ...
              <p>
                ...
                dejar en mal lugar al club, tanto en las zonas de concentración,
                mientras circulemos, en los lugares de descanso, etc.
              </p>
              <b>
              ...
              <p>
                ...
                manera respetuosa, peleas airadas, salidas de tono e insultos no
                serán permitidos.
              </p>
              <p>
                {" "}
              ...
              <p>
                3. El uso de las MAYÚSCULAS denota un tono alto de voz, así como
                un GRITO, por favor evite el uso de éstas puesto que es una
                norma básica para cualquier foro o Chat.
              </p>
              <p>
              ...
              <p>
                ...
                como: repuestos, componentes de vehículos eléctricos, mejoras a
                los vehículos eléctricos, servicios todos relacionados con los
                vehículos eléctricos.
              </p>
              <p>
                6. Está prohibido publicar cualquier comentario, texto o imagen
                que promocione actividades ilegales.
              </p>
              <p>
                7. Los miembros que posteen mensajes son responsables de lo que
                han escrito y asumen todo tipo de consecuencias de lo escrito,
                ejemplo difamación a cualquier persona natural o jurídica, se
              ...
              <p>
                9. Cualquier sugerencia que pueda mejorar el funcionamiento del
                club será bien recibida.
              </p>
              <p>
                10. Está prohibido el uso de vocabulario que pueda llegar a
                incomodar a los demás miembros del club. Ejemplo: “Holi” o coger
                el grupo de diario o Tinder, esto sin tener relación al objeto
                del club.
              </p>
              <p>
                11. Solamente podrán enviar encuestas los integrantes de la mesa
                de trabajo. Sin embargo, cuando se trate de asuntos académicos
                estas deben ser autorizadas por la mesa de trabajo.
              </p>
              <p>
              ...
              <p ref={ref}>
                ...
                compartir contenido de su actividad comercial sin previo acuerdo
